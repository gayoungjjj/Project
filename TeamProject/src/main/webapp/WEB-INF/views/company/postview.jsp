...
<style>
  ...
  table {
   ...
   table tr:last-of-type {background-color: white;}
     ...
     <tr>
      ...
      <c:if test="${login.user_id eq vo.user_id}">
       ...
       <a class="btn btn-outline-success" 
          href="/Company/Postlist?aplnum=${vo.aplnum}&user_id=${sessionScope.login.user_id}&compname=${sessionScope.login.compname}">목록</a>
      </td>
     </tr>
